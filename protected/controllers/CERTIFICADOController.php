...
class CERTIFICADOController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CERTIFICADO']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->CERTIFICADO_ID));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('CERTIFICADO');
	 ...
	 * @param CERTIFICADO $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='certificado-form')
		{
